...
/** The client has two confirmed formulas. The catalogue is seeded from these
 *  and then maintained in the admin panel — see docs/IMPLEMENTATION_PLAN.md.
 *  The demo placeholder products that once padded this list were removed with
 *  the move to a real catalogue. */
